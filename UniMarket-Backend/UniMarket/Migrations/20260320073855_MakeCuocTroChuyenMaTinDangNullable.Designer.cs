...
namespace UniMarket.Migrations
{
    ...
    [Migration("20260320073855_MakeCuocTroChuyenMaTinDangNullable")]
    partial class MakeCuocTroChuyenMaTinDangNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniMarket.Models.UserAffinity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniMarket.Models.UserAffinity", b =>
                {
                    b.HasOne("UniMarket.Models.ApplicationUser", "SourceUser")
                        .WithMany()
                        .HasForeignKey("SourceUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UniMarket.Models.ApplicationUser", "TargetUser")
                        .WithMany()
